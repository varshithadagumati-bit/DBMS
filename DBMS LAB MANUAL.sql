...
--
-- Current Database: `aiml`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `aiml` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `tcl` VALUES (64,'PRIYANTH',100000),(64,'PRIYANTH',23444),(64,'PRIYANTH',0);
/*!40000 ALTER TABLE `tcl` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tcl1`
--

DROP TABLE IF EXISTS `tcl1`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tcl1` (
  `ID` int DEFAULT NULL,
...
--
-- Dumping data for table `tcl1`
--

LOCK TABLES `tcl1` WRITE;
/*!40000 ALTER TABLE `tcl1` DISABLE KEYS */;
INSERT INTO `tcl1` VALUES (64,'DEEPIKA',100000),(64,'DEEPIKA',0),(64,'DEEPU',1222),(64,'DURGA',23444),(64,'DURGA',0);
/*!40000 ALTER TABLE `tcl1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'aiml'
--

--
-- Dumping routines for database 'aiml'
--
...
INSERT INTO `course_instructors` VALUES (1,'C101',10),(1,'C101',11),(2,'C101',10),(2,'C101',11),(1,'C102',11),(3,'C103',12),(3,'C104',13),(4,'C105',14),(4,'C106',15),(2,'C107',16),(1,'C108',17),(3,'C108',17);
...
INSERT INTO `instructor` VALUES (10,'Dr. Adams','555-0100'),(11,'Dr. Baker','555-0111'),(12,'Dr. Clark','555-0122'),(13,'Dr. Daniels','555-0133'),(14,'Dr. Evans','555-0144'),(15,'Dr. Foster','555-0155'),(16,'Dr. Green','555-0166'),(17,'Dr. Hill','555-0177');
...
INSERT INTO `student` VALUES (1,'Alice Smith','Computer Science'),(2,'Bob Jones','Mathematics'),(3,'Carol Lee','Physics'),(4,'David Kim','Electrical Engineering');
...
--
-- Current Database: `depps`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `depps` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `depps`;

--
-- Dumping events for database 'depps'
--

--
-- Dumping routines for database 'depps'
--

--
-- Current Database: `deepika`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `deepika` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
INSERT INTO `employee` VALUES (1,'DEEPS',6789,40000),(2,'PADHU',1234,50000);
...
INSERT INTO `stdinfo` VALUES (1,'DEEPIKA',100,'PASS'),(2,'GIRIJA',100,'PASS'),(3,'AKASH',100,'PASS'),(4,'KIRAN',100,'PASS'),(5,'PRIYA',55,'FAIL'),(6,'HASINI',85,'PASS');
/*!40000 ALTER TABLE `stdinfo` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'deepika'
--

--
-- Dumping routines for database 'deepika'
--

--
-- Current Database: `deeps`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `deeps` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;

USE `deeps`;

--
-- Temporary view structure for view `complexview`
--

DROP TABLE IF EXISTS `complexview`;
/*!50001 DROP VIEW IF EXISTS `complexview`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `complexview` AS SELECT 
 1 AS `NAME`,
 1 AS `salary`*/;
SET character_set_client = @saved_cs_client;

--
-- Temporary view structure for view `deeps`
--

DROP TABLE IF EXISTS `deeps`;
/*!50001 DROP VIEW IF EXISTS `deeps`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `deeps` AS SELECT 
 1 AS `name`,
 1 AS `salary`*/;
SET character_set_client = @saved_cs_client;
...
LOCK TABLES `employees` WRITE;
/*!40000 ALTER TABLE `employees` DISABLE KEYS */;
INSERT INTO `employees` VALUES (101,'Alice',1,50000.00),(102,'Bob',1,60000.00),(103,'Charlie',1,55000.00),(104,'David',2,40000.00),(105,'Eva',2,45000.00),(106,'Frank',2,70000.00),(107,'Grace',3,80000.00),(108,'Henry',3,82000.00),(109,'Ivy',3,75000.00);
/*!40000 ALTER TABLE `employees` ENABLE KEYS */;
UNLOCK TABLES;
...
DROP TABLE IF EXISTS `employeesss`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
...
--
-- Dumping data for table `employeesss`
--

LOCK TABLES `employeesss` WRITE;
/*!40000 ALTER TABLE `employeesss` DISABLE KEYS */;
INSERT INTO `employeesss` VALUES (1,'Alice',60000.00,10),(2,'Bob',45000.00,20),(3,'Charlie',75000.00,30),(4,'Diana',52000.00,20),(5,'Eve',40000.00,10);
/*!40000 ALTER TABLE `employeesss` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sales` VALUES (1,'Laptop','Electronics',3,800.00),(2,'Smartphone','Electronics',5,600.00),(3,'Desk','Furniture',2,150.00),(4,'Chair','Furniture',4,100.00),(5,'Mouse','Electronics',10,280.00);
...
INSERT INTO `student1` VALUES (1,'Deepu',99,97),(2,'Ashh',98,95),(3,'Padhma',98,99),(4,'hasini',NULL,89),(5,'Girija',78,NULL);
/*!40000 ALTER TABLE `student1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Dumping events for database 'deeps'
--

--
-- Dumping routines for database 'deeps'
--

--
-- Current Database: `deepss`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `deepss` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `cars` (
  `car_id` int NOT NULL,
  `car_name` varchar(60) DEFAULT NULL,
...
INSERT INTO `cars` VALUES (1,'Maruti',5300000),(2,'Tata',5000000),(3,'Hyundai',1200000),(4,'Mahindra',1400000);
...
INSERT INTO `cars1` VALUES (1,'Maruti',5300000),(2,'Tata',5000000),(3,'Hyundai',1200000),(4,'Mahindra',1400000);
...
LOCK TABLES `carss` WRITE;
/*!40000 ALTER TABLE `carss` DISABLE KEYS */;
INSERT INTO `carss` VALUES (1,'Maruti',5300000),(2,'Tata',5000000),(3,'Hyundai',1200000),(4,'Mahindra',1400000);
/*!40000 ALTER TABLE `carss` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `company1` WRITE;
/*!40000 ALTER TABLE `company1` DISABLE KEYS */;
INSERT INTO `company1` VALUES (1,'Brezza'),(2,'Nexon'),(3,'Creta'),(4,'XUV');
/*!40000 ALTER TABLE `company1` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `companyy`
--
...
--
-- Dumping data for table `companyy`
--

LOCK TABLES `companyy` WRITE;
/*!40000 ALTER TABLE `companyy` DISABLE KEYS */;
INSERT INTO `companyy` VALUES (1,'Brezza','black'),(2,'Tata','white'),(2,'Creta','black'),(4,'XUV','red');
/*!40000 ALTER TABLE `companyy` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `departments1` VALUES (1,'HR'),(2,'Finance'),(3,'IT'),(4,'Marketing');
...
LOCK TABLES `employees` WRITE;
/*!40000 ALTER TABLE `employees` DISABLE KEYS */;
INSERT INTO `employees` VALUES (101,'Alice',1),(102,'Bob',3),(103,'Charlie',3),(104,'David',2),(105,'Eva',4);
/*!40000 ALTER TABLE `employees` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `employees1` (
  ...
  PRIMARY KEY (`emp_id`),
  KEY `dept_id` (`dept_id`),
  CONSTRAINT `employees1_ibfk_1` FOREIGN KEY (`dept_id`) REFERENCES `departments1` (`dept_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `employees1` VALUES (101,'Alice',1),(102,'Bob',3),(103,'Charlie',3),(104,'David',2),(105,'Eva',4);
...
--
-- Dumping events for database 'deepss'
--

--
-- Dumping routines for database 'deepss'
--
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2025-07-09 06:06:28',NULL),('diagnostics.include_raw','OFF','2025-07-09 06:06:28',NULL),('ps_thread_trx_info.max_length','65535','2025-07-09 06:06:28',NULL),('statement_performance_analyzer.limit','100','2025-07-09 06:06:28',NULL),('statement_performance_analyzer.view',NULL,'2025-07-09 06:06:28',NULL),('statement_truncate_len','64','2025-07-09 06:06:28',NULL);
...
--
-- Final view structure for view `complexview`
--
...
/*!50001 VIEW `complexview` AS select `employeesss`.`name` AS `NAME`,`employeesss`.`salary` AS `salary` from (`employeesss` join `employees`) where (`employeesss`.`emp_id` = `employees`.`dept_id`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `deeps`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `deeps` AS select `employeesss`.`name` AS `name`,`employeesss`.`salary` AS `salary` from `employeesss` where (`employeesss`.`salary` > 50000) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2025-10-14 16:00:10
